...
we use ``backend.parser.dml_parser.parse_dml_string`` and pass through
...
def parse_dml(src: str) -> dict:
    ...
    Raises if no schema was parsed (mirrors the test suite's expectation
    that malformed input raises).
    """
